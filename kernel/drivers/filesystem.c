...
int efi_readfile(EFI_FILE_PROTOCOL* pdir, CHAR16* filename, void** pPfilebuffer, unsigned int* pfilesize){
	...
	if (status!=EFI_SUCCESS){
		printf("failed to read file into memory %x\r\n", status);
