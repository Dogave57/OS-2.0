...
MACOS_FLAGS="-cpu max,+x2apic,+apic -device qemu-xhci,id=xhci -device usb-kbd,bus=xhci.0 -trace "usb_xhci_*" -d guest_errors,unimp -D debug.log -serial stdio -device virtio-gpu"
