...
LINUX_FLAGS="-device qemu-xhci,id=xhci -device usb-mouse,bus=xhci.0 -device usb-kbd,bus=xhci.0 -device virtio-gpu-gl -display sdl,gl=es -vga none -serial stdio"
OS=$(uname -s)
