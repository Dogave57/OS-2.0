...
sudo $CC $CFLAGS -fpic -c kernel/subsystem/filesystem.c -o build/objects/subsystem/filesystem.o
sudo $CC $CFLAGS -fpic -c kernel/drivers/filesystem/fluxfs.c -o build/objects/drivers/filesystem/fluxfs.o
