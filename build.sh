...
KERNEL_CFLAGS='-O0 -mabi=ms -ffreestanding -mno-red-zone -fno-strict-aliasing -fno-stack-protector -fno-plt -Wno-multichar -fshort-wchar -Wno-address-of-packed-member -fno-reorder-blocks -Ikernel/include -Iuefi-headers/Include -Iuefi-headers/Include/X64 -fmax-errors=1 -fno-plt'
