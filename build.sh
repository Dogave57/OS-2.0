...
sudo mkdir build/objects/drivers/gpu/virtio
sudo mkdir build/objects/drivers/usb
sudo mkdir build/objects/drivers/fonts
sudo mkdir build/objects/drivers/shaders
...
$KERNELCC $KERNEL_CFLAGS -fPIC -c kernel/drivers/gpu/virtio/virtio.c -o build/objects/drivers/gpu/virtio/virtio.o
$KERNELCC $KERNEL_CFLAGS -fPIC -c kernel/drivers/gpu/virtio/tgsi.c -o build/objects/drivers/gpu/virtio/tgsi.o
...
$KERNELCC $KERNEL_CFLAGS -fpic -c kernel/subsystem/gpu.c -o build/objects/subsystem/gpu.o
$KERNELCC $KERNEL_CFLAGS -fpic -c kernel/drivers/dma-device.c -o build/objects/drivers/dma-device.o
$KERNELCC $KERNEL_CFLAGS -fpic -c kernel/math/basic.c -o build/objects/math/basic.o
...
$KERNELCC $KERNEL_CFLAGS -fpic -c kernel/drivers/shaders/tgsi.c -o build/objects/drivers/shaders/tgsi.o
$KERNELCC $KERNEL_CFLAGS -fpic -c kernel/drivers/shaders/ggsl.c -o build/objects/drivers/shaders/ggsl.o
